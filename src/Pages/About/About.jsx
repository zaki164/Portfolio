    ...
    <section className="About section_padding">
      ...
      <Container>
        <article className="qual_cont" data-aos={"fade-up"}>
          ...
          <p>
            <span>2022</span>
            <FontAwesomeIcon icon={faHandPointRight} /> Graduated with a very
            good grade , Bachelor in Computers and Control Systems Engineering,
            Mansoura University.
          </p>
        </article>
        <article className="About_Info" data-aos={"fade-up"}>
          <Row>
            ...
            <Col xs={12} md={6} className="col_info mb-3">
              <p>CV:</p>
              <a
                href="https://drive.google.com/file/d/15XbTzFtuuFMX0C4arOsFGvRLWYcNtROO/view?usp=drive_link"
